...
void Application::Display(void)
{
	...
	m_m4Model *= ToMatrix4(glm::angleAxis(glm::radians(m_v3Rotation.x), vector3(1.0f, 0.0f, 0.0f)));
	m_m4Model *= ToMatrix4(glm::angleAxis(glm::radians(m_v3Rotation.y), vector3(0.0f, 1.0f, 0.0f)));
	m_m4Model *= ToMatrix4(glm::angleAxis(glm::radians(m_v3Rotation.z), vector3(0.0f, 0.0f, 1.0f)));
